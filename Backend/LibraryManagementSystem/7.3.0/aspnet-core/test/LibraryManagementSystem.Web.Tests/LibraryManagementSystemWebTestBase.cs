...
{
    public abstract class LibraryManagementSystemWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static LibraryManagementSystemWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(LibraryManagementSystemWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<LibraryManagementSystemDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<LibraryManagementSystemDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<LibraryManagementSystemDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<LibraryManagementSystemDbContext, Task<T>> func)
        {
            T result;
